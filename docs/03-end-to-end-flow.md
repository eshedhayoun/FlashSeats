...
| `flashseats.payment.decline.ratio` | gauge, per replica | a spike is either a provider incident or a fraud rule mis-firing, and both used to look like silence |
